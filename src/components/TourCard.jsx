    ...
    return (
        <div className="bg-white h-140 sm:h-180 md:h-125 rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 group">
            <div className="relative h-56 overflow-hidden">
                ...
                />
                <div className="absolute top-3 right-3 bg-white/90 backdrop-blur-sm text-gray-800 text-xs px-2 py-1 rounded-full font-medium 
                    shadow-md">
            ...
            <div className="p-6">
                ...
                {/* URL dạng: /tour/kiss-saigon-by-night */}
                <Link
                    to={`/tour/${tour.slug}`}
